...
\begin{figure}[H]
    ...
    \newcommand{\drawmultifan}[3]{
        \begin{scope}[shift={(#1,0)}]
            ...
            % e1
            \ifnum#2=2 \draw[edge_style, cRed] (xc) -- (y1); \else \ifnum#2=0 \draw[edge_style, cRed] (xc) -- (y1); \else \ifnum#2=5 \draw[edge_style, cYellow] (xc) -- (y1); \fi \fi \fi
